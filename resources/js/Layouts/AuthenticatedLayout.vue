                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('admin.list')" :active="route().current('admin.*')">
                                    {{ $t('nav.admin') }}
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('guarantors.list')" :active="route().current('guarantors.*')">
                                    {{ $t('guarantor.guarantors') }}
                                </NavLink>
                            </div>
                        </div>
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            ...
                                            >
                                                <img v-if="$page.props.auth.user.avatar" :src="'/storage/avatars/' +  $page.props.auth.user.avatar" alt="Avatar" class="h-10 w-10 mr-4">
